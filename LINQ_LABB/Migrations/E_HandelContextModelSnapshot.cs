...
{
    [DbContext(typeof(E_HandelContext))]
    partial class E_HandelContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LINQ_LABB.Modules.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LINQ_LABB.Modules.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LINQ_LABB.Modules.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LINQ_LABB.Modules.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LINQ_LABB.Modules.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LINQ_LABB.Modules.Supplier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LINQ_LABB.Modules.Order", b =>
                {
                    b.HasOne("LINQ_LABB.Modules.Customer", "Customer")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("LINQ_LABB.Modules.OrderDetail", b =>
                {
                    b.HasOne("LINQ_LABB.Modules.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LINQ_LABB.Modules.Product", "Product")
                        .WithMany("OrderDetails")
            ...
            modelBuilder.Entity("LINQ_LABB.Modules.Product", b =>
                {
                    b.HasOne("LINQ_LABB.Modules.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LINQ_LABB.Modules.Supplier", "Supplier")
                        .WithMany("Products")
